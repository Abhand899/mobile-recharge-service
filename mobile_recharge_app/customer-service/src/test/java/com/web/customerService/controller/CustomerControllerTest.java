...
public class CustomerControllerTest {
	...
	public void cancelCustomerRechargePlanTest() {
		long customerId=3l;
		long rechargeId = 1l;
		when(customerServiceImpl.cancelCustomerRechargePlans(rechargeId, customerId)).thenReturn("CANCELLED");
		ResponseEntity<String> response = customerController.cancellingCustomerRechargePlans(customerId, rechargeId);
		assertThat(response.getStatusCodeValue()).isEqualTo(200);
		assertEquals(response.getBody(), "CustomerId : " + customerId
	...
	@Test
	public void subscribePlanTestTest() {
		long customerId = 2l;
		long rechargeId = 1l;
		when(customerServiceImpl.subscribingPlan(customerId, rechargeId)).thenReturn("RECHARGED");
		ResponseEntity<String> response = customerController.subscribePlan(customerId, rechargeId);
