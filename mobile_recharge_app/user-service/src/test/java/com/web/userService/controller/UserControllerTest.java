...
public class UserControllerTest {
	...
	public void updateCustomerDetailsTest() {
		...
		rechargeIds.add(1l);
		customer.setRechargeIds(rechargeIds);
		when(userServiceImpl.updateCustomerDetails(customer.getCustomerId(), customer)).thenReturn(customer);
	...
	public void deleteCustomerDetailsFailTest() throws Exception {
		long customerId = 119l;
		ResponseEntity<Object> response = userController.deleteCustomerById(customerId);
		assertThat(response.getStatusCodeValue()).isEqualTo(404);
	}

	@Test
	public void createCustomerForUserDetailsTest() {
		Customer customer = new Customer();
		customer.setCustomerId(11l);
		customer.setActive(true);
		customer.setCustomerName("Karan");
		...
		rechargeIds.add(1l);
		customer.setRechargeIds(rechargeIds);
		ResponseEntity<String> response = userController.createCustomerDetailsForUsers(customer);
	...
	public void subscribePlanFailTest() {
		...
		ResponseEntity<String> response = userController.subscribePlan(customerId, rechargeId);
